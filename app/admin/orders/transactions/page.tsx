          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-[var(--border-color)]">
              {filteredTransactions.map((tx, idx) => (
                <tr key={tx.id + idx} className="hover:bg-black/5 dark:hover:bg-white/5 transition-colors group cursor-pointer animate-in fade-in slide-in-from-bottom-2" style={{ animationDelay: `${idx * 50}ms` }}>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      <div className="flex items-center gap-2">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/255px-Flag_of_India.svg.png" className="w-3 h-2" alt="IN" />
                      </div>
                  ...
                  <td className="px-6 py-4 text-center text-[var(--brand-primary)]">
                    <button className="p-2 rounded-full hover:bg-[var(--brand-primary)]/10 transition-colors">
