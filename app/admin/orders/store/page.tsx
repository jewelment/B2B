...
export default function StoreOrdersPage() {
  ...
  const mockOrders = [
    ...
    { id: '#PCJ-0005999', date: '12-07-2026 at 2:30 pm', fulfilledBy: 'Store', user: 'amit sharma', items: 2, total: 15400.00, paymentStatus: 'Success', orderStatus: 'Processing' },
    { id: '#PCJ-0005980', date: '11-07-2026 at 10:15 am', fulfilledBy: 'Store', user: 'neha gupta', items: 1, total: 4500.00, paymentStatus: 'Failed', orderStatus: 'Failed' },
  ];

  const storeFiltersConfig: FilterGroup[] = [
    {
      id: 'order_status',
      title: 'Order Status',
      options: [
  ...
  return (
    <div className="p-8 max-w-[1600px] mx-auto animate-in fade-in duration-500 min-h-screen relative flex flex-col">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-[var(--text-main)]">Store Orders</h1>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm relative overflow-hidden group">
          ...
          <p className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Store Orders</p>
        </div>
        <div className="bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-[var(--brand-primary)]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
          <h3 className="text-3xl font-bold text-[var(--text-main)] mb-1">₹0</h3>
          <p className="text-xs font-bold uppercase tracking-widest text-[var(--text-muted)]">Store Order Amount</p>
        </div>
        <div className="bg-[var(--bg-surface)] border border-[var(--border-color)] rounded-2xl p-6 shadow-sm relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-br from-[var(--brand-primary)]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
          <h3 className="text-3xl font-bold text-[var(--text-main)] mb-1">5</h3>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[var(--border-color)] bg-black/5 dark:bg-white/5">
                ...
                <th className="px-6 py-4 text-[10px] font-bold uppercase tracking-widest text-[var(--text-muted)]">Order Info ({mockOrders.length})</th>
      ...
      <FiltersDrawer 
        ...
        filtersConfig={storeFiltersConfig} 
