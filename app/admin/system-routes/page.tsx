...
export default function SystemRoutesAuditor() {
  ...
  const routes: Route[] = [
    ...
    // --- Admin / Salesman ---
    { path: '/admin', label: 'Executive E-Commerce Dashboard', type: 'Admin', status: 'Active', lastModified: '21 July 2026, 11:45 AM' },
    { path: '/admin/catalog', label: 'Master Catalog (PIM)', type: 'Admin', status: 'Active' },
    { path: '/admin/pricing', label: 'Master Pricing & Bullion', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    { path: '/admin/pricing/live-rates', label: 'Omnichannel Live Rates Engine', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    { path: '/admin/inventory/master-grid', label: 'Master Inventory Grid (Data-Dense)', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    { path: '/admin/inventory/grid', label: 'Global Inventory Engine', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    ...
    { path: '/admin/inventory/stores', label: 'Inventory Store Allocation', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    { path: '/admin/inventory/reviews', label: 'Product Reviews Workflow', type: 'Admin', status: 'Active', lastModified: '21 July 2026' },
    { path: '/admin/products/edit/[id]', label: 'Single Product Editor', type: 'Admin', status: 'Active', lastModified: '21 July 2026, 11:45 AM' },
