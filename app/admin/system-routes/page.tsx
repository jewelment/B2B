...
export default function SystemRoutesAuditor() {
  ...
  const routes: Route[] = [
    ...
    { path: '/admin/orders', label: 'PO Inbox', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/all', label: 'All Orders (Master)', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/ecommerce', label: 'E-Com Orders', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/store', label: 'Store Orders', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/transactions', label: 'All Transactions', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/all-pos', label: 'Master PO Ledger', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/all-pos/[id]', label: 'Purchase Order Details', type: 'Admin', status: 'Active' },
    { path: '/admin/orders/[id]', label: 'Order Summary', type: 'Admin', status: 'Active' },
