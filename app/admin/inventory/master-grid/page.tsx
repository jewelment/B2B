    ...
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-main)] font-sans p-6 md:p-10 selection:bg-[var(--brand-primary)]/20 selection:text-[var(--brand-primary)]">
      ...
      <div className="w-full space-y-10 max-w-[1600px] mx-auto">
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <button className="px-5 py-2.5 border border-[var(--border-color)] bg-[rgba(255,255,255,0.02)] backdrop-blur-md rounded-full text-xs font-bold uppercase tracking-widest hover:bg-black/5 dark:hover:bg-white/5 transition-all active:scale-95 shadow-sm">
              Export Matrix
            </button>
            <button className="px-6 py-2.5 bg-[var(--brand-primary)] text-[var(--brand-text)] rounded-full text-xs font-bold uppercase tracking-widest shadow-[0_4px_20px_rgba(0,0,0,0.1)] shimmer-hover transition-all">
              + New Product
            </button>
          </div>
        </motion.div>
