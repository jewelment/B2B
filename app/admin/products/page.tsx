    ...
    <div className="p-8 max-w-full mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 min-h-screen">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <button className="px-6 py-2.5 bg-[var(--brand-primary)] text-[#121212] rounded-full text-sm font-bold shadow-[0_4px_20px_rgba(var(--brand-primary-rgb),0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all shimmer-hover flex items-center gap-2">
